...
pio run -e xiaosenses3_phoeyeleft -v > build_xiaosenses3_phoeyeleft_log.txt
pio run -e xiaosenses3_phoeyeright -v > build_xiaosenses3_phoeyeright_log.txt
...
for target in targets:
    ...
    run_command(f"pio run --environment {target} -v > build_{target}_log.txt ")
